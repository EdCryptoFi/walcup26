...
function Header() {
  return (
    <header className="sticky top-0 z-50 border-b border-wc-border bg-wc-dark/90 backdrop-blur-sm">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <nav className="hidden md:flex items-center gap-1 text-sm">
            <Link href="/" className="rounded-lg px-3 py-1.5 text-gray-400 hover:bg-wc-card hover:text-white transition-colors">
              Home
            </Link>
            <Link href="/groups" className="rounded-lg px-3 py-1.5 text-gray-400 hover:bg-wc-card hover:text-white transition-colors">
              Groups
            </Link>
            <Link href="/users" className="rounded-lg px-3 py-1.5 text-gray-400 hover:bg-wc-card hover:text-white transition-colors">
              Players
            </Link>
            <Link href="/dashboard" className="rounded-lg px-3 py-1.5 text-gray-400 hover:bg-wc-card hover:text-white transition-colors">
              Dashboard
            </Link>
          </nav>
    ...
    <html lang="en">
      <body>
        <Providers>
          ...
          <footer className="mt-16 border-t border-wc-border py-8">
